...
**Note:** If you are using Android 6 (Marshmallow) and unable to connect, try this workaround: Tap the settings icon next to your VPN profile. Select "Show Advanced Options" and scroll down to the bottom. If the option "Backwards-compatible mode" exists, enable it and reconnect the VPN.
